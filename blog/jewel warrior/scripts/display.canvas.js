jewel.display = (function() {
  ...
  function addAnimation(runTime, fncs) {
    // console.log('display.canvas.addAnimation');
    var anim = {
      runTime: runTime,
      startTime: Date.now(),
      pos: 0,
  ...
  function explode(callback) {
    ...
    console.log('adding explode animation');
    addAnimation(2000, {
      before: function(pos) {
  ...
  function explodePieces(pieces, pos, delta) {
     console.log('explodePieces! Length: ' + pieces.length);
    var piece, i;
    for(i = 0; i < pieces.length; i++) {
      ...
      // console.log('# ' + i + ': ' + piece.pos.x + ' ' + piece.pos.y + ', type: ' + piece.type);
      // console.log('# ' + i + ' vel.y: ' + piece.vel.y);
      // console.log(pos);

      ctx.save();
      console.log('ctx.save()');
      // clearJewel(piece.pos.x, piece.pos.y);
  ...
  function moveJewels(movedJewels, callback) {
    console.log('display.canvas.moveJewels');
  ...
  function removeJewels(removedJewels, callback) {
    console.log('display.canvas.removeJewels');
  ...
  function setup() {
    ...
    boardElement.appendChild(createBackground(cols, rows));
  ...
  function drawJewel(type, x, y, scale, rot) {
    ...
    ctx.drawImage(jewelSprite, type * jewelSize, 0, jewelSize, jewelSize,
  ...
  function redraw(newJewels, callback) {
    console.log('display.canvas.redraw');
    var x, y;
    jewels = newJewels,
  ...
  function refill(newJewels, callback) {
    console.log('display.canvas.refill');
    var lastJewel = 0;
    addAnimation(1000, {
      render: function(pos) {
  ...
  function createBackground(cols, rows) {
