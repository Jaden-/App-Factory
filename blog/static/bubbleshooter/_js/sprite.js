  ...
  var Sprite = function() {
    ...
    this.animate = function(destination, config) {
      ...
      that.updateFrame = function() {
        ...
        if(proportion > 1)
          proportion = 1;
        var posLeft = startPosition.left + (destination.left -
          startPosition.left) * proportion;
        var posTop = startPosition.top + (destination.top -
          startPosition.top) * proportion;
        that.css({
          left: posLeft,
          top: posTop
        });
